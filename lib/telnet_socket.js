...
const EscapedIAC = Buffer.from([Commands.IAC, Commands.IAC]);
...
module.exports = class TelnetSocket extends Duplex {
    ...
    get escapeIACs()  {
        return this.escapeIACsEnabled;
    }

    set escapeIACs(enabled) {
        this.escapeIACsEnabled = enabled;
    }
    ...
    _write(data, encoding, cb) {
        ...
        if ('string' === typeof data) {
            return this.socket.write(data.replace(/\xff/g, '\xff\xff'), encoding, cb);
        }
